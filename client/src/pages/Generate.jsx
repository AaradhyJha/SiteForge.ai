        ...
        <div className='min-h-screen bg-linear-to-br from-[#050505] via-[#0b0b0b] to-[#050505] text-white'>
            ...
            <div className='max-w-6xl mx-auto px-6 py-16'>
                ...
                >
                    ...
                    <p className='text-zinc-400 max-w-2xl mx-auto'>This process may take a few moments. At Siteforge.ai, we prioritize quality over shortcuts.
                    </p>
                ...
                {loading && (
                    ...
                    >
                        ...
                        <div className='text-center text-xs text-zinc-400 mt-4'>Sit back and relax while we craft your website with precision and care.
                        </div>
